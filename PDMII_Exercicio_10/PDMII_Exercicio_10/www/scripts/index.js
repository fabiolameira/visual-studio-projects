...
(function () {
    ...
    function verifyLocaleStrings() {
        try {
            var string = strings[locale].birthDate;
        }
        catch (error) {
    ...
    function setLanguage() {
        $('#btnInsert').html(strings[locale].btnInsert);
        $('#btnListView').html(strings[locale].btnListView);
    ...
    function listDetails(i) {
        ...
        html = "<ul data-role='listview' data-inset='true'>" +
            ...
            "<li><b>" + strings[locale].birthDate + ": </b>" + personsList[i].birthDate + "</li>" +
            "<li><b>" + strings[locale].town + ": </b>" + personsList[i].town + "</li>" +
            "<li><b>" + strings[locale].email + ": </b>" + personsList[i].email + "</li>" +
            "<li><b>" + strings[locale].phone + ": </b>" + personsList[i].phone + "</li>" +
            "</ul>";
