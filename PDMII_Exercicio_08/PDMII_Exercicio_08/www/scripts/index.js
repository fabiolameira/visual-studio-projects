...
(function () {
    ...
    function onDeviceReady() {
        ...
        buttonPickPhoto.addEventListener("touchend", sourceConfirm, false);
    ...
    function listDetails(i) {
        ...
        html += "<li id='photo'><img class='photo' src='" + personsList[i].photo + "'></li>";
        html += "<li data-role='list-divider' class='capitalize'><b>Nome:</b> " + personsList[i].name + "</li>";
